    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('titulo', models.CharField(max_length=255, null=True) if RENDER_EXTERNAL_HOSTNAME else models.CharField(db_collation='utf8mb4_unicode_ci', max_length=255, null=True)),
